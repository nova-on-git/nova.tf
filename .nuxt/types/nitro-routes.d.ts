...
declare module 'nitropack' {
  ...
  interface InternalApi {
    ...
    '/api/chatrooms/documents/:id': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/chatrooms/documents/[id].get').default>>>>
    }
    ...
    '/api/emails': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/emails/index.post').default>>>>
    }
    '/api/galleries': {
    ...
    '/api/notifications/:uid': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/notifications/[uid].get').default>>>>
    }
    '/api/notifications': {
    ...
    '/api/payments': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/payments/index.post').default>>>>
    }
    '/api/projects/:id': {
    ...
    '/api/projects/documents': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/projects/documents.get').default>>>>
    }
    '/api/projects/ids': {
    ...
    '/api/projects/update-amount-paid': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/projects/update-amount-paid').default>>>>
    }
    ...
    '/api/stripe/orderWebhook': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../../dashboard/server/api/stripe/orderWebhook.post').default>>>>
    }
    ...
    '/__nuxt_error': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.7_eslint@9.13.0_jiti@2.3.3__ioredis@5.4.1__fbzjvsiirqoutu6sxmmi2qonsq/node_modules/nuxt/dist/core/runtime/nitro/renderer').default>>>>
    }
  }
}
export {}